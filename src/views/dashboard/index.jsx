...
const Dashboard = () => {
  ...
  const fetchCounts = async () => {
    try {
      ...
      setOrderCount(orderCountData.count || 0);
      setServiceCount(serviceCountData.count || 0);
    } catch (error) {
...
//         { id: 'cash', status_name: 'Cash' },
//         { id: 'upi', status_name: 'UPI' },
//         { id: 'bank_transfer', status_name: 'Bank Transfer' },
//         { id: 'cheque', status_name: 'Cheque' },
//         { id: 'card', status_name: 'Card' }
//       ],
//       menuItem: { label: 'status_name', value: 'id' },
//     },
//     {
...
//                 <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
//                   <Box>
//                     <Typography variant="h6" sx={{ fontWeight: 600, opacity: 0.9, mb: 1, color: 'white' }}>
//                       Total Orders
//                     </Typography>
//                     <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
//                       {loadingCounts ? (
...
//                 <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
//                   <Box>
//                     <Typography variant="h6" sx={{ fontWeight: 600, opacity: 0.9, mb: 1 }}>
//                       Total Services
//                     </Typography>
//                     <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
//                       {loadingCounts ? (
